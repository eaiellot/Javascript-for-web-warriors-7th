...
function validateRequired() {
	...
	var travelbook = document.getElementsByName("travel");
	...
	if (!travelbook[0].checked && !travelbook[1].checked && !travelbook[2].checked) {
		// verify that a travel is selected
		travelbook[0].style.outline = "1px solid red";
		travelbook[1].style.outline = "1px solid red";
		travelbook [2].style.outline = "1px solid red";
		fieldsetValidity = false;
	} else {
		travelbook[0].style.outline = "";
		travelbook[1].style.outline = "";
		travelbook[2].style.outline = "";
}
